...
function validateElement(element){if(element.type!=="text"&&element.type!=="textarea"&&element.type!=="password"&&element.type!=="hidden"){alert("simple.validator发生错误：只支持验证文本类型的表单元素。\n\n错误产生于元素："+element+"\n不支持的表单元素类型："+element.type);}
